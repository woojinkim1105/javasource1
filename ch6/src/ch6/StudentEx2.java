...
public class StudentEx2 {
	...
	public static void main(String[] args) {
		...
		//초기화
		stuArr[0] = new Student2("홍길동", 1, 1, 45, 66, 77);
		stuArr[1] = new Student2("성춘향", 1, 2, 66, 87, 59);
		stuArr[2] = new Student2("서유기", 1, 3, 35, 39, 80);
		stuArr[3] = new Student2("김미남", 1, 4, 77, 54, 91);
		stuArr[4] = new Student2("이서진", 1, 5, 81, 79, 90);
